...
module.exports = {
    ...
    async execute(interaction, prem) {
        ...
        if (interaction.options.getString("action") == "set") {
            ...
            if (!channel) return interaction.reply("Please provide a proper text channel!")
            if (channel.type != "GUILD_TEXT") return interaction.reply("Please provide a proper text channel!")
